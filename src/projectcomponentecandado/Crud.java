...
public class Crud {
    ...
    public void insertarDatos(String nombre_tdpersonales, String apellido_tdpersonales, String carrera_tdpersonales, int numControl_tdpersonales){
        try{
           String query = "INSERT INTO `TabladatosPersonales`"
                   + "(`nombre_tdpersonales`,`apellido_tdpersonales`,`carrera_tdpersonales`,`numcontrol_tdpersonales`)"
                   + "VALUES ('"+nombre_tdpersonales+"','"+apellido_tdpersonales+"','"+carrera_tdpersonales+"','"+numControl_tdpersonales+"'";
           st.execute(query);
        }catch(Exception e){
            e.printStackTrace();
        }
